...
import pl.polsl.carsdealership.Model.Backend;
import pl.polsl.carsdealership.Model.Car;
...
public class MenuController implements Initializable{
    ...
    private void addNewCar() throws IOException{
        if(!Model.getText().isEmpty() && !Color.getText().isEmpty() &&
                    ...
                    backend.checkIfYearInRange(Integer.parseInt(Year.getText())))
            {
                ...
                openDialogWindow("/pl/polsl/carsdealership/WrongValue.fxml");
            }
        }else{
            openDialogWindow("/pl/polsl/carsdealership/WrongValue.fxml");
        }
    ...
    private void buyCar() throws IOException {
        ...
        if(!tableView.getSelectionModel().getSelectedItems().isEmpty()){
            if(Integer.parseInt(Balance.getText()) >= tableView.getSelectionModel().getSelectedItem().getPrice()){
                ...
                deleteFromTable();
                openDialogWindow("/pl/polsl/carsdealership/BoughtCar.fxml");

            }else{
                openDialogWindow("/pl/polsl/carsdealership/PoorPerson.fxml");
            }
        }
    }
    ...
    private void addMoney() throws IOException {
        ...
        FXMLLoader fxmlloader = new FXMLLoader(getClass().getResource("/pl/polsl/carsdealership/AddMoneyDialog.fxml"));
        Parent parent = fxmlloader.load();
